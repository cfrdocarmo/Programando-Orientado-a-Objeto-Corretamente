...
public class Aluno extends Pessoa {
	...
	/*Método que retorna uma String para aprovado e para reprovado*/
	...
	public String msgMaiorIdade() {
		return this.pessoaMaiorIdade() ? "Oba aluno é maior de idade " : "Ixe vc é menor de idade";
	}
